...
const connection_url = 'mongodb+srv://19522417:Truc2001@facebook-likenew.ye19o27.mongodb.net/facebook-likenew'
...
app.get('/', (req, res) => res.status(200).send('Hello Truc'))
